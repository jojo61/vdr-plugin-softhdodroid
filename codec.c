...
static int CodecAudioUpdateHelper(AudioDecoder * audio_decoder, int *passthrough)
{
    ...
    *passthrough = 0;
    ...
    audio_decoder->HwChannels = CodecDownmix ? 2 : audio_ctx->ch_layout.nb_channels;
#endif
...
#if LIBAVCODEC_VERSION_INT < AV_VERSION_INT(59,24,100)
    int64_t dmlayout = AV_CH_LAYOUT_STEREO_DOWNMIX;
#else
    AVChannelLayout dmlayout = AV_CHANNEL_LAYOUT_STEREO_DOWNMIX;
#endif
