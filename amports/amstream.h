...
#define AMSTREAM_IOC_GET_VIDEO_LAYER1_ON  _IOR((AMSTREAM_IOC_MAGIC), 0x23, int)
/*video pip IOCTL command list*/
#define AMSTREAM_IOC_CLEAR_VIDEOPIP _IOW((AMSTREAM_IOC_MAGIC), 0x24, int)
#define AMSTREAM_IOC_CLEAR_PIP_VBUF _IO((AMSTREAM_IOC_MAGIC), 0x25)
...
#define AMSTREAM_IOC_GET_VIDEOPIP_AXIS   _IOR((AMSTREAM_IOC_MAGIC), 0x2f, int)
#define AMSTREAM_IOC_SET_VIDEOPIP_AXIS   _IOW((AMSTREAM_IOC_MAGIC), 0x30, int)
#define AMSTREAM_IOC_GET_VIDEOPIP_CROP   _IOR((AMSTREAM_IOC_MAGIC), 0x31, int)
#define AMSTREAM_IOC_SET_VIDEOPIP_CROP   _IOW((AMSTREAM_IOC_MAGIC), 0x32, int)
#define AMSTREAM_IOC_GET_PIP_SCREEN_MODE _IOR((AMSTREAM_IOC_MAGIC), 0x33, int)
#define AMSTREAM_IOC_SET_PIP_SCREEN_MODE _IOW((AMSTREAM_IOC_MAGIC), 0x34, int)
#define AMSTREAM_IOC_GET_PIP_ZORDER  _IOW((AMSTREAM_IOC_MAGIC), 0x35, unsigned int)
#define AMSTREAM_IOC_SET_PIP_ZORDER  _IOW((AMSTREAM_IOC_MAGIC), 0x36, unsigned int)

#define AMSTREAM_IOC_GET_ZORDER  _IOW((AMSTREAM_IOC_MAGIC), 0x37, unsigned int)
#define AMSTREAM_IOC_SET_ZORDER  _IOW((AMSTREAM_IOC_MAGIC), 0x38, unsigned int)

#define AMSTREAM_IOC_QUERY_LAYER  _IOW((AMSTREAM_IOC_MAGIC), 0x39, unsigned int)
#define AMSTREAM_IOC_ALLOC_LAYER  _IOW((AMSTREAM_IOC_MAGIC), 0x3a, unsigned int)
#define AMSTREAM_IOC_FREE_LAYER  _IOW((AMSTREAM_IOC_MAGIC), 0x3b, unsigned int)
